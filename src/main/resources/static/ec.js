...
(function($) {
    ...
    var setInputValuesFromHash = function() {
        ...
        for (var i = 0; i < items.length; i += 1) {
            ...
            if (item.length !== 2 || !name || !value || /[^a-z]/.test(name) || /[^-.0-9]/.test(value)) {
                continue;
            }
    ...
    $.ec.Base.prototype.setLabel = function(label, p) {
        if (p === null) {
            ...
            var xScale = this.plotContainer.width() / (this.plotRange.xMax - this.plotRange.xMin);
            var yScale = this.plotContainer.width() / (this.plotRange.yMax - this.plotRange.yMin);
    ...
    $.ec.Base.prototype.recalculate = function() {
        this.singular = (4 * this.a * this.a * this.a + 27 * this.b * this.b) === 0;
        // Order is important.
    ...
    $.ec.Base.prototype.updateResults = function() {
        ...
        this.equationContainer.html("<em>y</em><sup>2</sup> = " + "<em>x</em><sup>3</sup> " + getTerm(this.a, "<em>x</em>") + getTerm(this.b, ""));
    ...
    $.ec.reals.Base.prototype = Object.create($.ec.Base.prototype);
    ...
    $.ec.reals.Base.prototype.getCurvePoints = function() {
        ...
        var points = [];
        var curve = this;
        var step = (this.plotRange.xMax - this.plotRange.xMin) / this.plotResolution;
    ...
    $.ec.reals.Base.prototype.getLinePoints = function(p, q) {
        ...
        if (!isFinite(m)) {
            ...
            return [[p[0], this.plotRange.yMin], [p[0], this.plotRange.yMax]];
        }

        return [[this.plotRange.xMin,
        m * (this.plotRange.xMin - p[0]) + p[1]], [this.plotRange.xMax,
    ...
    $.ec.reals.Base.prototype.fixPointCoordinate = function(xInput, yInput) {
        ...
        if (xVal !== xPrevVal) {
            if (xVal < this.roots[0]) {
                ...
                xVal = this.roots[0];
                yVal = 0;
            } else if (this.roots.length > 2 && this.roots[1] < xVal && xVal < this.roots[2]) {
    ...
    $.ec.reals.PointAddition.prototype = Object.create($.ec.reals.Base.prototype);
    $.ec.reals.PointAddition.prototype.constructor = $.ec.reals.PointAddition;
    ...
    $.ec.reals.ScalarMultiplication.prototype = Object.create($.ec.reals.Base.prototype);
    $.ec.reals.ScalarMultiplication.prototype.constructor = $.ec.reals.ScalarMultiplication;
    ...
    $.ec.modk.Base.prototype.getLinePoints = function(p, q) {
        ...
        if (isNaN(m)) {
            if (p[1] === q[1]) {
                // We are in the case p === q.
                m = (3 * p[0] * p[0] + this.a) * this.inverseOf(2 * p[1]);
            } else {
        ...
        if (m === 0) {
            ...
            return [[this.plotRange.xMin, p[1]], [this.plotRange.xMax, p[1]]];
        }
    ...
    $.ec.modk.Base.prototype.updateResults = function() {
        ...
        this.compositeWarning.css({
            "display": this.prime ? "none" : "block"
        });
    ...
    $.ec.modk.PointAddition.prototype.getPlotData = function() {
        ...
        if (this.r !== null) {
            data.push({
                color: colors.red,
                data: [this.r, [this.r[0], this.k - this.r[1]]],
                lines: {
                    show: true
                }
            });
    ...
    $.ec.modk.ScalarMultiplication.prototype = Object.create($.ec.modk.Base.prototype);
    $.ec.modk.ScalarMultiplication.prototype.constructor = $.ec.modk.ScalarMultiplication;
